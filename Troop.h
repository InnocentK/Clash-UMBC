 ...
 **                                                                            
 ** This file contains the declerations for all member functions of the        
 ** troop class and lists out the private variables available to troop objects
 **                                                                            
 ** This file remains unedited from Professor's Dixion's original copy outside 
 ** of this header comment                                                     
 ***************************************/
